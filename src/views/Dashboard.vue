                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myAreaChart" width="1102" height="440" style="display: block; height: 352px; width: 882px;" class="chartjs-render-monitor"></canvas></div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myBarChart" width="1102" height="440" style="display: block; height: 352px; width: 882px;" class="chartjs-render-monitor"></canvas></div>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-4">
...
export default {
  name: 'Dashboard',
  setup() {
    const myAreaChart = ref(null);
    const myBarChart = ref(null);

    onMounted(() => {
      // Initialization for the charts if necessary
      // Add logic to initialize myAreaChart and myBarChart
    });
...
.datatable-info, .datatable-pagination {
  display: flex;
